...
const FeaturedProducts = ({featureList}) =>
{
      ...
      return(
        ...
        <div className="product-item bg-light mb-4">
          ...
          <div className="text-center py-4">
            <a className="h6 text-decoration-none text-truncate" href="">{currentId.product_name}</a>
            <div className="d-flex align-items-center justify-content-center mt-2">
              <h5><span class="WebRupee">Rs.</span>{currentId.price}</h5><h6 className="text-muted ml-2"><del><span class="WebRupee">Rs.</span>{currentId.rate}</del></h6>
            </div>
